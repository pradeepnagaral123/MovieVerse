...
import { searchMovies, imageUrl, isApiKeySet } from '../services/omdb';
      ...
      <main className="pt-28 pb-20 px-4 md:px-12 max-w-[1280px] mx-auto">
        ...
        <section className="mb-10">
          <form onSubmit={handleSearch} className="relative search-glow transition-all duration-300 rounded-2xl max-w-3xl">
              ...
              placeholder="Search movies by title, mood, color, or director..."
              type="text"
              value={searchInput}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-[24px] font-bold text-on-surface mb-2">No movies found</h2>
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-on-surface-variant text-[16px] max-w-md">
              Type a movie title, actor, director, or even a mood in the search bar above to discover
              films.
            </p>
          </div>
        )}
